                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-secondary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Today's Return</span>
                                <span class="info-box-number">{{ $today->sum('return') }} Taka</span>
                                @php

                                    if($yesterday->sum('return') != 0)
                                    {
                                        $percentage = (($today->sum('return') - $yesterday->sum('return'))/ $yesterday->sum('return'))*100;
                                    } else {
                                        $percentage = 0;
                                    }
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-secondary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">This Month's Return</span>
                                <span class="info-box-number">{{ $month->sum('return') }} Taka</span>
                                @php

                                    if($previous_month->sum('return') != 0)
                                    {
                                        $percentage = (($month->sum('return') - $previous_month->sum('return'))/ $previous_month->sum('return'))*100;
                                    } else {
                                        $percentage = 0;
                                    }
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-secondary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">This Year's Return</span>
                                <span class="info-box-number">{{ $year->sum('return') }} Taka</span>
                                @php
                                    if($previous_year->sum('return') != 0)
                                    {
                                        $percentage = (($year->sum('return') - $previous_year->sum('return'))/ $previous_year->sum('return'))*100;
                                    } else {
                                        $percentage = 0;
                                    }
                                @endphp
                    ...
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="info-box bg-secondary">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text mt-3 pb-1">Total Return</span>
                                <span class="info-box-number mb-3">{{ $sales->sum('return') }} Taka</span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
