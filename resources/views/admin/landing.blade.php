    ...
    <div class="features_section pb-20">
        <div class="container mx-auto">
            <div class="features_heading lg:pt-20 lg:px-0 md:pt-20 md:px-0 pt-5 px-8">
                <h1 class="flex font-bold justify-center lg:text-4xl md:text-4xl text-2xl text-whiteblue">Whats included? </h1>
                <p class="flex justify-center lg:ml-0 md:ml-0 ml-4 text-seagull-700 text-sm">Everything you need to schedule and monitor your background jobs without writing any code.</p><span class="flex justify-center text-sm text-seagull-700">  Focus on your application, and we will handle the scheduling part.</span>
            </div>
            <div class="features flex grid lg:grid-cols-3 md:grid-cols-2 mt-10 sm:grid-cols-1">
                <div class="features_item px-5 py-5">
                    <div class="features_ico">
                        <svg class="bg-whiteblue float-left lg:mt-0 md:mt-0 mt-3 px-3 py-3 rounded-lg text-seagull-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" height="30%" width="30%">
        ...
        <div class="container mx-auto">
            <div class="work_wrapper">
                <div class="work_heading">
                    <h1 class="flex font-bold justify-center lg:pb-1 lg:text-4xl mb-5 md:pb-1 md:text-2xl text-2xl text-atlantis-500 text-seagull-500">How does it work?</h1>
                </div>
                <div class=" work_section_1 overflow-hidden ">
                    <div class="lg:float-left lg:pb-0 lg:pl-20 lg:w-1/2 md:pb-0 md:pl-20 md:w-1/2 pb-4 pl-10 sm:float-none work_article">
        ...
        <div class="question_area">
            <div class="container mx-auto pt-5 pb-5 ">
                <div class="lg:pb-10 md:pb-10 pb-4 question_heading">
                    <h1 class="flex font-bold justify-center lg:text-4xl md:text-2xl sm:text-2xl text-downy-700">Frequently asked questions ?</h1>
                </div>
                <div class="question_articles w-auto">
                    <div class="question_item">
                        <div class="tab overflow-hidden">
                            <input class="absolute opacity-0 " id="tab-multi-one" type="checkbox" name="tabs">
                            <label class="block border-2 border-downy-700 cursor-pointer leading-normal lg:text-2xl md:text-2xl pl-2 text-1xl text-downy-700" for="tab-multi-one">How does Cronhub scheduler work?</label>
                        ...
                        <div class="tab overflow-hidden">
                            ...
                            <label class="block border-2 border-downy-700 cursor-pointer leading-normal lg:text-2xl md:text-2xl pl-2 text-1xl text-downy-700" for="tab-multi-three">How does Cronhub scheduler work?</label>
                            <div class="tab-content bg-downy-200" >
                                <p class="py-5 pl-8 text-downy-800 border-l-2 border-r-2 border-downy-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</p>
                            </div>
                        </div>
                        <div class="tab overflow-hidden">
                            ...
                            <label class="block border-2 border-downy-700 cursor-pointer leading-normal lg:text-2xl md:text-2xl pl-2 text-1xl text-downy-700" for="tab-multi-four">How does Cronhub scheduler work?</label>
                            <div class="tab-content bg-downy-200" >
                                <p class="py-5 pl-8 text-downy-800 border-l-2 border-r-2 border-downy-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</p>
                            </div>
                        </div>
                        <div class="tab overflow-hidden">
                            ...
                            <label class="block border-2 border-downy-700 cursor-pointer leading-normal lg:text-2xl md:text-2xl pl-2 text-1xl text-downy-700" for="tab-multi-five">How does Cronhub scheduler work?</label>
                            <div class="tab-content bg-downy-200" >
                                <p class="py-5 pl-8 text-downy-800 border-l-2 border-r-2 border-downy-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</p>
                            </div>
                        </div>
                        <div class="tab overflow-hidden">
                            ...
                            <label class="block border-2 border-downy-700 cursor-pointer leading-normal lg:text-2xl md:text-2xl pl-2 text-1xl text-downy-700" for="tab-multi-two">How does Cronhub scheduler work?</label>
                            <div class="tab-content bg-downy-200" >
                                <p class="py-5 pl-8 text-downy-800 border-l-2 border-r-2 border-downy-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur, architecto, explicabo perferendis nostrum, maxime impedit atque odit sunt pariatur illo obcaecati soluta molestias iure facere dolorum adipisci eum? Saepe, itaque.</p>
                            </div>
                        </div>
...
{{--                        <a href="#"><span class="ml-5" ><i class="fa--f fab lg:px-3 lg:py-2 lg:text-2xl md:px-3 md:py-2 md:text-2xl px-3 py-2 rounded-full text-xs" style="background: #409DF6"></i></span></a>--}}
    ...
    <div class="lg:text-xl md:text-xl text-center  text-xs text-downy-900"> © Copyright 2020 Kodeeo - All Rights reserved</div>
    <div class="wave">
