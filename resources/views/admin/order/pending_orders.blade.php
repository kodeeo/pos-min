                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">ALL ORDERS LISTS</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
...
{{--                                            <td>{{ $order->product->name }}</td>--}}
                                            ...
                                            <td><a href="{{ $order->customer ? route('admin.customer.show', optional($order->customer)->id) : '#'  }}">{{optional($order->customer)->name}}</a></td>
