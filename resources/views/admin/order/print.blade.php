                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <b>Payment Status:</b> <span class="badge {{ $order->payment_status == 'paid' ? 'badge-success' : 'badge-warning'  }}">{{ $order->payment_status }}</span><br>
                        ...
                        <div class="col-4">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Return</th>
                                        <td class="text-right">{{ number_format($order->return, 2) }}</td>
                                    </tr>
                                    <tr>
                                        <th>Due</th>
